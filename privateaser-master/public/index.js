...
function step2(){
  for(var i=0;i<events.length;i++){
    for(var j=0;j<bars.length;j++){
      if(bars[j].id==events[i].barId){
        if(events[i].persons>60){events[i].price=events[i].persons*bars[j].pricePerPerson*0.5+events[i].time*bars[j].pricePerHour;}
        else if(events[i].persons>20){events[i].price=events[i].persons*bars[j].pricePerPerson*0.7+events[i].time*bars[j].pricePerHour;}
        else if(events[i].persons>10){events[i].price=events[i].persons*bars[j].pricePerPerson*0.9+events[i].time*bars[j].pricePerHour;}
        else{events[i].price=events[i].persons*bars[j].pricePerPerson+events[i].time*bars[j].pricePerHour;}
      }
    }
  }
}
    ...
    for(var j=0;j<events.length;j++){
      if(actors[i].eventId==events[j].id){
        for(var k=0;k<actors[i].payment.length;k++){
          ...
          else{actors[i].payment[k].amount=events[j].commission.privateaser+events[j].persons;}
        }
      }
    }
  }
